...
<div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Menambahkan buku baru</h3>
        </div>
        ...
        <form method="POST" action="{{ url('/books/add') }}">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Ex: Biografi si fulan" name="name" required autocomplete="off">
                    @error('name')
                        <div class="alert alert-danger mt-2">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Pengarang buku (opsional)" name="author" autocomplete="off">
                </div>
                <div class="form-group">
